...
export default function Home() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
            <div className="flex flex-col items-center gap-4 pr-0 pt-8 bg-slate-100 rounded-lg shadow-sm">
              ...
              <div className="w-full relative h-full">
                <img src="/Invoice.png" alt="sdch" className="w-full mr-10" />
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 flex flex-row">
      ...
      <section className="min-h-[300px] bg-[#1ba078] text-white flex items-center text-4xl text-center">
        <p>
          An
